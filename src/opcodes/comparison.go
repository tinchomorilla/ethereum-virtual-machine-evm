...
func OpEQ(e types.Executor) (types.OpResult, error) {
	stack := e.GetStack()
...
func OpLT(e types.Executor) (types.OpResult, error) {
	stack := e.GetStack()
...
func OpGT(e types.Executor) (types.OpResult, error) {
	stack := e.GetStack()
...
func OpISZERO(e types.Executor) (types.OpResult, error) {
	stack := e.GetStack()
...
func OpSLT(e types.Executor) (types.OpResult, error) {
	stack := e.GetStack()
...
func OpSGT(e types.Executor) (types.OpResult, error) {
	stack := e.GetStack()
