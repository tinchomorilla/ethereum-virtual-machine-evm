...
func OpAND(e types.Executor) error {
	stack := e.GetStack()
...
func OpOR(e types.Executor) error {
	stack := e.GetStack()
	a, b, err := popTwoArgs(stack)
	if err != nil {
		return err
...
func OpXOR(e types.Executor) error {
	stack := e.GetStack()
	a, b, err := popTwoArgs(stack)
	if err != nil {
		return err
...
func OpNOT(e types.Executor) error {
	stack := e.GetStack()
	a, err := stack.Pop()
	if err != nil {
		return err
...
func OpSHL(e types.Executor) error {
	stack := e.GetStack()
...
func OpSHR(e types.Executor) error {
	stack := e.GetStack()
	shift, value, err := popTwoArgs(stack)
	if err != nil {
		return err
...
func OpSAR(e types.Executor) error {
	stack := e.GetStack()
	shift, value, err := popTwoArgs(stack)
	if err != nil {
		return err
